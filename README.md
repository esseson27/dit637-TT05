...
I am a student completing a technical lab on TT05: DevSecOps CI/CD Deployment with GitHub Actions and Amazon EC2. I have implemented an automated backend deployment pipeline using GitHub Actions, Amazon EC2, and SSH
...
- name: Copy backend to EC2
  run: |
    ...
    -i ~/.ssh/deploy_key \
    ubuntu@${{ secrets.EC2_PUBLIC_DNS }} \
    "rm -rf ~/backend-expressjs"
